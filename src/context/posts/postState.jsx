...
import {
 ...
 const PostState = (props) => {
    ...
    const getPosts = async (options) => {
        ...
        if(options){
            ...
            const params = {
                ...
                state: options.state ? options.state : 'all',
            ...
            build = `${params.page ? 'page='+params.page : 'page=1'}${'&per_page='+params.perPage}`;
    ...
    const getTaggedPosts = async (options) => {
        ...
        if(options){
            ...
            build = `${params.page ? 'page='+params.page : 'page=1'}${'&tags='+params.tags}`;
